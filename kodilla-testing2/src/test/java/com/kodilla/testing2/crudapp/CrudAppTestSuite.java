...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://mateusz-surmac.github.io/";
    ...
    private void cleanCrudApp(String taskName) throws InterruptedException {
        while(!driver.findElement(By.xpath("//select[1]")).isDisplayed());

        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]")).
                        getText().equals(taskName))
                .forEach(form -> {WebElement clearElement = form.findElement(By.xpath(".//button[@data-task-delete-button]"));
                clearElement.click();
                });
        Thread.sleep(2000);
    }
